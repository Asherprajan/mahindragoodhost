...
export default function PricingSection() {
  const pricingData = [
    ...
    { type: "3 BHK + Study", area: "2150 Sq.Ft", size: "2150 Sq.Ft (Carpet Area)", price: "On Request*" },
    { type: "4 BHK", area: "2450 Sq.Ft", size: "2450 Sq.Ft (Carpet Area)", price: "On Request*" },
  ]
          ...
          <div className="w-full lg:w-1/3">
            <Card className="shadow-xl overflow-hidden transform hover:scale-105 transition-all duration-300 border-t-4 border-red-500">
              ...
              <CardContent className="p-6">
                ...
                <Button className="w-full bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 shadow-lg hover:shadow-red-300/30 transition-all">
